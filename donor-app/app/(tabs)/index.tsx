/**
 * Profile Tab (also handles registration gate)
 * 
 * If donor is not registered → redirects to /register
 * If registered → shows profile
 * Uses useDonorProfile ViewModel.
 */
...
import { useDonorProfile } from '../../src/viewmodels/useDonorProfile';
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>{profile.id.slice(0, 18)}...</Text>
        </View>
      ...
      <View style={[
        styles.statusBar,
        profile.availability ? styles.statusActive : styles.statusInactive,
      ]}>
        <View style={[
          styles.statusDot,
          profile.availability ? styles.dotActive : styles.dotInactive,
        ]} />
        <Text style={[
          styles.statusText,
          profile.availability ? styles.textActive : styles.textInactive,
        ]}>
