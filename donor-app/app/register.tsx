 ...
 * 
 * Shown when donor is not yet registered.
 * Form: Name, Blood Type, Availability, GPS Location.
 * Uses useDonorRegistration ViewModel.
 */
...
import { useDonorRegistration } from '../src/viewmodels/useDonorRegistration';
import type { BloodType } from '../src/models/donor';
